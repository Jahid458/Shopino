    ...
    <div className="min-h-screen bg-linear-to-br from-sky-50 via-white to-sky-100 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
      <div className="w-full max-w-sm sm:max-w-md">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-slate-800">Login</h1>
          <p className="text-slate-500 text-xs sm:text-sm mt-1">Welcome back! Please sign in to continue</p>
        </div>
